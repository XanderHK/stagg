...
export const denormalizeWzMatchRaw = (e:MW.Match.WZ) => ({
    matchId: e.matchID,
    mapId: e.map,
    modeId: e.mode,
    startTime: e.utcStartSeconds,
    endTime: e.utcEndSeconds,
    teamId: e.player.team,
    score: e.playerStats.score,
    downs: [
        e.playerStats.objectiveBrDownEnemyCircle1 || 0,
        e.playerStats.objectiveBrDownEnemyCircle2 || 0,
        e.playerStats.objectiveBrDownEnemyCircle3 || 0,
        e.playerStats.objectiveBrDownEnemyCircle4 || 0,
        e.playerStats.objectiveBrDownEnemyCircle5 || 0,
        e.playerStats.objectiveBrDownEnemyCircle6 || 0,
        e.playerStats.objectiveBrDownEnemyCircle7 || 0,
        e.playerStats.objectiveBrDownEnemyCircle8 || 0,
        e.playerStats.objectiveBrDownEnemyCircle9 || 0,
        e.playerStats.objectiveBrDownEnemyCircle10 || 0,
        e.playerStats.objectiveBrDownEnemyCircle11 || 0,
    ],
    kills: e.playerStats.kills,
    deaths: e.playerStats.deaths,
    damageDone: e.playerStats.damageDone,
    damageTaken: e.playerStats.damageTaken,
    teamWipes: e.playerStats.objectiveTeamWiped,
    executions: e.playerStats.executions,
    headshots: e.playerStats.headshots,
    revives: e.playerStats.objectiveReviver,
    contracts: e.playerStats.objectiveBrMissionPickupTablet,
    lootCrates: e.playerStats.objectiveBrCacheOpen,
    buyStations: e.playerStats.objectiveBrKioskBuy,
    timePlayed: e.playerStats.timePlayed,
    avgLifeSpan: null,
    teamPlacement: e.playerStats.teamPlacement,
    teamSurvivalTime: e.playerStats.teamSurvivalTime,
    bestKillstreak: e.playerStats.longestStreak,
    distanceTraveled: Number(e.playerStats.distanceTraveled), // decimal numbers must be recast on fetch
    percentTimeMoving: Number(e.playerStats.percentTimeMoving),
    gulagKills: e.playerStats.gulagKills,
    gulagDeaths: e.playerStats.gulagDeaths,
    clusterKills: e.playerStats.objectiveMedalScoreSsKillTomaStrike,
    airstrikeKills: e.playerStats.objectiveMedalScoreKillSsRadarDrone,
    trophyDefense: e.playerStats.objectiveTrophyDefense,
    munitionShares: e.playerStats.objectiveMunitionsBoxTeammateUsed,
    missileRedirects: e.playerStats.objectiveManualFlareMissileRedirect,
    equipmentDestroyed: e.playerStats.objectiveDestroyedEquipment,
    xp: {
        match: e.playerStats.matchXp,
        score: e.playerStats.scoreXp,
        bonus: e.playerStats.bonusXp,
        medal: e.playerStats.medalXp,
        misc: e.playerStats.miscXp,
        challenge: e.playerStats.challengeXp,
        total: e.playerStats.totalXp,
    }
})
